...
public class BrowseDatabase {
    ...
    public BrowseDatabase(String username, String password) {
    ...
    public static void main(String[] args) {
        if( args.length < 2 ) {
            System.out.println( "usage: BrowseDatabase username password" );
            return;
        }
        
        BrowseDatabase printDb = new BrowseDatabase( args[ 0 ], args[ 1 ] );
        printDb.execute();
    }
